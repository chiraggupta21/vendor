...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 uppercase text-left">
			...
			<div class="col-sm-7 text-left">
				<!-- <button type="button" class="btn btn-default"
					onclick="window.location.href='/Maven-product/prod/list';return false;">
					Product</button>
				<button type="button" class="btn btn-default"
					onclick="window.location.href='/Maven-product/vend/list';return false;">
					Vendor</button> -->
				<ul class="nav nav-tabs">
					<li><a href="/Maven-product/prod/list">Product</a></li>
					<li class="active"><a href="/Maven-product/vend/list">Vendor</a></li>
				</ul>
					...
					<div id="product" class="tab-pane fade in active">
						...
						<table class="table-fill">
							...
							<c:forEach var="temp" items="${vendors}">
								<c:url var="viewLink" value="/vend/view">
									<c:param name="vendId" value="${temp.getId()}"></c:param>
								</c:url>
