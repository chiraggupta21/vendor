	...
	<div class="container-fluid">
		...
		<div class="col-sm-9 text-left">
			...
			<div class="row">
				...
				<label class="control-label col-sm-2">${temp.getName()}</label>
			</div>
			<div class="row">
				<h3 class="control-label col-sm-2">Product List</h3> 
			</div>
				<c:forEach var="tem" items="${temp.getProductList()}">
					<div class="row">
						<label class="control-label col-sm-2">${tem.getId()}</label>
						<label class="control-label col-sm-2">${tem.getName()}</label>
						<label class="control-label col-sm-2">${tem.getCategory()}</label>
						<label class="control-label col-sm-2">${tem.getPrice()}</label>
					</div>
				</c:forEach>
		</div>
	</div>
